...
<html lang="en">
  <head>
    ...
    <!-- <link rel="style" href="login.php"> -->
    <title>login system!</title>
  </head>
  <body>
    <!-- unable to connect phplogic and html interface -->
  ...
  <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="register.php">SignUp / Register</a>
      </li>
      <li class="nav-item">
...
<form action="" method="POST">
  ...
  <div class="form-group form-check">
    ...
    <label class="form-check-label" for="exampleCheck1">Remember my Login info</label>
  </div>
  <button type="submit" class="btn btn-primary">Submit</button>
  <div class="external_connection"><p>Don't have an account? 
